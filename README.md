...
### Please see https://github.com/pop-os/cosmic-protocols/issues/8 for more info:

Cosmic tries to support already-existing Wayland prtocol extensions, such as those made by and for [wlroots](https://gitlab.freedesktop.org/wlroots/wlroots).
